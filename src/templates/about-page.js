            ...
            <div className="section">
              ...
              <div className="tile" style={{padding: '1.25em', backgroundColor:'rgb(240, 76, 39)'}}>
                    ...
                    <ul style={{color: 'white', marginTop: '2.5em', listStyleType: 'none'}}>
                      <li>Agrupament Escolta Antoni Gaudí</li>
                      <li>AMBICI Cooperativa de missatgeria ecològica</li>
                      <li>AMPA CEIP Progrés Badalona</li>
                      ...
                      <li>Associació de veïns de Coll i Pujol</li>
                      ...
                      <li>AVV Sant Antoni de Llefià</li>
                      ...
                      <li>undos arquitectura cooperativa</li>
